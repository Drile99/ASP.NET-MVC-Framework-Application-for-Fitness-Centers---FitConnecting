...
namespace DomaciZadatak.Models.LinqSql
{
    ...
    partial void OnJMBGChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Drzi_Rezervisan_Termin", Storage="_Rezervisan_Termins", ThisKey="AktivnostID,JMBG", OtherKey="AktivnostID,JMBG")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Korisnik_Drzi", Storage="_Korisnik", ThisKey="JMBG", OtherKey="JMBG", IsForeignKey=true)]
    ...
    partial void OnLozinkaChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Korisnik_Drzi", Storage="_Drzis", ThisKey="JMBG", OtherKey="JMBG")]
		public EntitySet<Drzi> Drzis
		{
			get
			{
    ...
    partial void OnAktivnostIDChanged();
		...
		public long JMBG
		{
			...
			set
			{
				if ((this._JMBG != value))
				{
					if ((this._Drzi.HasLoadedOrAssignedValue || this._Korisnik.HasLoadedOrAssignedValue))
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnJMBGChanging(value);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Drzi_Rezervisan_Termin", Storage="_Drzi", ThisKey="AktivnostID,JMBG", OtherKey="AktivnostID,JMBG", IsForeignKey=true)]
		public Drzi Drzi
		{
			get
			{
